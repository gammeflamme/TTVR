...
public class v2RightControllerScript : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (OVRInput.Get(OVRInput.RawAxis1D.RHandTrigger) == 1)//använder OVRInput för att checka om spelaren använder högra grabb knappen
        {
